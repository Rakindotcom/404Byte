...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#161b22] border-t border-[#2d3748] py-4 md:py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="block md:hidden">
          ...
          <div className="flex items-center justify-between mb-3">
            <button onClick={() => handleNavigation('/')} className="flex items-center group">
              <img
                src="/logo.png"
                alt="404Byte Logo"
                className="w-8 h-8 mr-2 transform group-hover:rotate-12 transition-transform duration-300"
              />
              <span className="text-lg font-black font-['Space_Grotesk'] text-white group-hover:text-[#00BFFF] transition-colors duration-300">
                404Byte
              </span>
            </button>
            <div className="flex space-x-2">
              <button
                ...
                className="group w-8 h-8 bg-[#0D1117] border border-[#2d3748] rounded-lg flex items-center justify-center hover:border-[#00BFFF] hover:bg-[#00BFFF]/10 transition-all duration-300"
              >
                <svg className="w-3 h-3 text-[#A9B2BA] group-hover:text-[#00BFFF] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="group w-8 h-8 bg-[#0D1117] border border-[#2d3748] rounded-lg flex items-center justify-center hover:border-[#00FFC6] hover:bg-[#00FFC6]/10 transition-all duration-300"
              >
                <svg className="w-3 h-3 text-[#A9B2BA] group-hover:text-[#00FFC6] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Links Row */}
          <div className="flex justify-around items-start text-xs">
            ...
            <div className="flex flex-col space-y-1">
              <span className="text-white font-semibold mb-1">Services</span>
              <span className="text-[#A9B2BA]">Web Development</span>
              <span className="text-[#A9B2BA]">App Development</span>
              <span className="text-[#A9B2BA]">UI/UX Design</span>
              <span className="text-[#A9B2BA]">Digital Marketing</span>
              <span className="text-[#A9B2BA]">Brand Development</span>
              <span className="text-[#A9B2BA]">Media Production</span>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-12">
          ...
          <div className="col-span-2">
            <button onClick={() => handleNavigation('/')} className="inline-flex items-center mb-4 group">
              <img
                src="/logo.png"
                alt="404Byte Logo"
            ...
            <p className="text-[#A9B2BA] mb-3 max-w-md leading-relaxed">
          ...
          {/* Services */}
          <div>
            <h3 className="text-white font-bold mb-3 text-lg">Services</h3>
            <ul className="space-y-3">
        ...
        {/* Bottom section */}
        <div className="border-t border-[#2d3748] mt-3 md:mt-6 pt-2 md:pt-4 text-center">
          <p className="text-[#A9B2BA] text-sm md:text-base">

      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="grid grid-cols-3 gap-2 md:gap-4 mb-8">
          <div className="flex flex-col items-center">
            <div className="w-10 h-10 md:w-16 md:h-16 bg-gradient-to-br from-[#00BFFF] to-[#00FFC6] rounded-full flex items-center justify-center mb-2 md:mb-4">
              <svg className="w-5 h-5 md:w-8 md:h-8 text-[#0D1117]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z"/>
              </svg>
            </div>
            <h4 className="text-xs md:text-xl font-bold text-white mb-1 md:mb-2">Fast Delivery</h4>
            <p className="text-[#A9B2BA] text-center text-[10px] md:text-base">Projects delivered on time, every time</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h4 className="text-xs md:text-xl font-bold text-white mb-1 md:mb-2">Quality Guaranteed</h4>
            <p className="text-[#A9B2BA] text-center text-[10px] md:text-base">98% client satisfaction rate</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h4 className="text-xs md:text-xl font-bold text-white mb-1 md:mb-2">Ongoing Support</h4>
            <p className="text-[#A9B2BA] text-center text-[10px] md:text-base">24/7 support and maintenance</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#161b22] to-[#1a1f2e] rounded-3xl p-4 md:p-6 border border-[#2d3748]">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-4">
            <div className="text-center">
              <div className="w-8 h-8 md:w-12 md:h-12 bg-[#00BFFF] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-4">
                <svg className="w-4 h-4 md:w-6 md:h-6 text-[#0D1117]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
              </div>
              <h4 className="text-xs md:text-lg font-bold text-white mb-1 md:mb-2">Email Us</h4>
              <p className="text-[#00BFFF] text-[10px] md:text-base break-all">hello@404byte.com</p>
              <p className="text-[#A9B2BA] text-[8px] md:text-sm">Response within 24 hours</p>
            </div>
            
            <div className="text-center">
              <div className="w-8 h-8 md:w-12 md:h-12 bg-[#00FFC6] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-4">
                <svg className="w-4 h-4 md:w-6 md:h-6 text-[#0D1117]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                </svg>
              </div>
              <h4 className="text-xs md:text-lg font-bold text-white mb-1 md:mb-2">Call Us</h4>
              <p className="text-[#00FFC6] text-[10px] md:text-base">+1 (555) 404-BYTE</p>
              <p className="text-[#A9B2BA] text-[8px] md:text-sm">Mon-Fri 9AM-6PM EST</p>
            </div>
            
            <div className="text-center">
              <div className="w-8 h-8 md:w-12 md:h-12 bg-[#00BFFF] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-4">
                <svg className="w-4 h-4 md:w-6 md:h-6 text-[#0D1117]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="text-xs md:text-lg font-bold text-white mb-1 md:mb-2">WhatsApp</h4>
              <p className="text-[#00BFFF] text-[10px] md:text-base">+1 (555) 404-BYTE</p>
              <p className="text-[#A9B2BA] text-[8px] md:text-sm">Instant messaging</p>
            </div>
          </div>
        </div>
      </div>

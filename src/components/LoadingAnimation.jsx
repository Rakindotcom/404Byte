  ...
  return (
    <div className="fixed inset-0 bg-[#0D1117] z-50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 border border-[#00BFFF]/20 rotate-45 animate-spin-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 border border-[#00FFC6]/20 rotate-12 animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 border-2 border-[#00BFFF]/30 animate-ping"></div>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className={`text-center transition-all duration-1000 ${showLogo ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}>
          ...
          <div className={`relative ${showGlitch ? 'animate-glitch' : ''}`}>
            <h1 className="text-8xl md:text-9xl font-black text-white font-['Space_Grotesk'] relative">
            ...
            {/* Holographic Effect */}
            <div className="absolute -inset-8 bg-gradient-to-r from-[#00BFFF]/20 via-transparent to-[#00FFC6]/20 blur-2xl animate-pulse"></div>
          </div>
          ...
          {/* Loading Text */}
          <p className="text-[#A9B2BA] text-lg mt-6 font-mono">
      ...
      {/* Corner Brackets */}
      <div className="absolute top-8 left-8 w-16 h-16 border-t-2 border-l-2 border-[#00BFFF] animate-pulse"></div>
      <div className="absolute top-8 right-8 w-16 h-16 border-t-2 border-r-2 border-[#00FFC6] animate-pulse"></div>
      <div className="absolute bottom-8 left-8 w-16 h-16 border-b-2 border-l-2 border-[#00FFC6] animate-pulse"></div>
      <div className="absolute bottom-8 right-8 w-16 h-16 border-b-2 border-r-2 border-[#00BFFF] animate-pulse"></div>
